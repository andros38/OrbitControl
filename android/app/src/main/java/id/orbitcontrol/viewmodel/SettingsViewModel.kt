...
class SettingsViewModel(
    ...
    fun exportDebugReport() {
        ...
        viewModelScope.launch {
            ...
            runCatching { debugReportRepository.export() }
                .onSuccess { file ->
                    _uiState.update {
                        it.copy(exportingReport = false, reportMessage = "Laporan siap dibagikan.", reportError = false)
                    }
    ...
    fun reportShareFailed() {
        _uiState.update { it.copy(reportMessage = "Tidak ada aplikasi yang dapat membagikan laporan.", reportError = true) }
    }
